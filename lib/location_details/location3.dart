...
class Location3Page extends StatelessWidget {
  // URL for Google Maps with Directions (Coop UTHM Gym & Fitness Centre)
  final String mapUrl = 'https://maps.app.goo.gl/JWvGMxe9K4FZmESs9'; // Coop UTHM Gym link
              ...
              Container(
                decoration: BoxDecoration(
                  image: DecorationImage(
                    image: AssetImage("assets/location3.jpg"),
                    fit: BoxFit.cover,
                  ),
                ),
              ),
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  Flexible(
                                    child: Text(
                                      "Lot 111 A, Jalan Universiti 5, Taman Universiti, 86400 Parit Raja, Johor Darul Ta'zim",
                                    ),
                                  ),
                                ],
                              ),
                          ...
                          GestureDetector(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(8),
                                image: DecorationImage(
                                  image: AssetImage('assets/map3.jpg'),
                                  fit: BoxFit.cover,
                                ),
                              ),
                            ),
